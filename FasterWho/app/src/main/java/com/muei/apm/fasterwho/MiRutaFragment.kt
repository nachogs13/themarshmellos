...
class MiRutaFragment : Fragment() {
    ...
    private var tagMiRuta = "MiRutaFragment"
                    ...
                    .get().addOnSuccessListener {
                        ...
                        for (document in it) {
                            try {
                                ...
                                nombreRuta = document.data["nombre"].toString()
                                ...
                                Log.d(tagMiRuta, "Fallo al obtener la información de una ruta privada")
                            }
                        ...
                        if (puntuacion!=0F || distancia!=0 || dificultad!=0F || longitudBuscada != 0F){
                            ...
                            if (filteredList.isNotEmpty()){
                                ...
                                adapter = MyMiRutaRecyclerViewAdapter(filteredList)
                            } else {
